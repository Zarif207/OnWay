...
const steps = [
  {
    ...
    description:
      "Seamlessly book your vehicle using our intuitive mobile app. One tap is all it takes.",
    image: step1Img,
  },
  {
    id: "02",
    ...
    description:
      "Instant dispatch: We connect you with a premium, nearby driver within seconds.",
    image: step2Img,
  },
  {
    id: "03",
    ...
    description:
      "Sit back, relax, and track your trip in real-time until you reach your destination.",
    image: step3Img,
  },
];
...
import {
  StaggerContainer,
  AnimatedHeading,
} from "../../root-components/MotionWrappers";
        ...
        <div className="text-center mb-20">
          <AnimatedHeading>
            <h2 className="text-4xl md:text-5xl font-black text-secondary leading-tight tracking-tighter">
              Your journey{" "}
              <span className="bg-linear-to-r from-[#2FCA71] to-[#259461] bg-clip-text text-transparent">
                redefined
              </span>{" "}
  ...
  return (
    ...
    >
      ...
      <div className="relative mb-10 w-[70px] h-[70px] bg-white rounded-full flex items-center justify-center border-[3px] border-dotted border-gray-200 group-hover:border-primary transition-colors duration-300 z-10">
        <span className="text-2xl font-bold text-secondary group-hover:text-primary transition-colors duration-300">
          {step.id}
        </span>
      </div>
