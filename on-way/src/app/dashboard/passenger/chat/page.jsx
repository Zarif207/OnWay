...
export default function PassengerChatPage() {
    ...
    const filteredChats = useMemo(() => {
        ...
        if (supportChat) {
            ...
            const supportMatch =
                supportChat.senderName
                    .toLowerCase()
                    .includes(query);

            if (!query || supportMatch) {
                chats = [supportChat, ...chats];
            }
    ...
    const chatType = selectedChat?.type === "support"
        ? "support"
        : "ride";
    ...
    return (
        <div className="flex h-screen text-gray-700 font-sans overflow-hidden p-4">
            ...
            <div className="max-w-[1700px] w-full mx-auto bg-white md:rounded-[2.5rem] flex overflow-hidden border border-gray-100 relative h-full">
                ...
                <aside className={`${showMobileList ? "flex" : "hidden md:flex"} w-full md:w-[200px] lg:w-[350px] flex-col border-r border-gray-50`}>
                                ...
                                >
                                    ...
                                    <div className="relative shrink-0">
                                        ...
                                        ${isSupport
                                            ...
                                            {isSupport ? "S" : chat.senderName?.[0]}

                                        </div>

                                        {!isSupport && onlineStatus[chat.riderId] === "online" && (
                                    ...
                                    <div className="flex-1 text-left min-w-0">
                                        ...
                                        ${chat.unreadCount > 0 ? "text-emerald-600" : "text-gray-400"}`}>
                ...
                <main className="flex-1 flex flex-col">
                    ...
                    {!selectedChat ? (
                        ...
                        <>
                                ...
                                <div>
                                    ...
                                    {selectedChat.type !== "support" && (
                                        <span className="text-[9px] font-black tracking-widest text-emerald-500 uppercase">
                                            {onlineStatus[selectedChat.riderId] === "online"
                                                ? "Online"
                                                : "Offline"}
                                        </span>
                                    )}
                            ...
                            <div
                                ref={scrollRef}
                                className="flex-1 overflow-y-auto px-6 py-8 space-y-6 bg-[#FAFAFF]/40"
                            >
                            ...
                            <footer className="p-6 border-t border-gray-50">
                                ...
                                {sendError && (
                                    ...
                                    <div className="mb-3 p-3 bg-red-50 text-red-600 rounded-2xl border border-red-100 flex items-center justify-between text-xs font-bold">
                                        ...
                                        <button
                                            ...
                                            className="px-3 py-1 bg-red-100 rounded-xl text-[10px]"
                                        >
                                            Dismiss
                                        </button>
                                ...
                                <div className="flex items-center gap-3 bg-gray-50 p-2 rounded-[2.5rem] border border-gray-100">
                                    ...
                                    <button
                                        ...
                                        className="p-4 text-gray-400 hover:text-emerald-500"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="bg-emerald-600 text-white p-4 rounded-full disabled:bg-gray-200 shadow-lg"
                                    >
                                        <Send size={20} />
                                    </button>
