...
export default function RiderInboxPage() {
    ...
    // ✅ support chat-এ otherUserId null — useChat sendMessage-এ rider role দেখে handle করবে
                    ...
                    {selected ? (
                        <>
                            ...
                            <header className="h-24 px-8 border-b border-gray-50 flex items-center justify-between shrink-0">
                                ...
                                {/* ✅ Video & Audio call — আলাদা options */}
                            ...
                            <div
                                ref={scrollRef}
                                className="flex-1 overflow-y-auto px-6 py-8 space-y-4 bg-[#FAFAFF]/40"
                            >
                                {messagesLoading && messages.length === 0 ? (
                                    ...
                                    messages.map((m, i) => (
                                        <div
                                            key={m._id || i}
                                            className={`flex ${m.senderId === String(user._id)
                                                ? "justify-end"
                                                : "justify-start"}`}
                                        >
