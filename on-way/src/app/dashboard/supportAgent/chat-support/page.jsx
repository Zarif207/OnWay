    ...
    return (
        <div className="flex h-screen text-gray-700 font-sans overflow-hidden p-4">
            <div className="max-w-425 w-full mx-auto bg-white md:rounded-[2.5rem] flex overflow-hidden border border-gray-100 relative h-full">
                ...
                {/* ══ CHAT AREA ═════════════════════════════════════════ */}
                <main className={`${!showMobileList || showChat ? "flex" : "hidden md:flex"} flex-1 flex-col bg-white relative h-full min-h-0 overflow-hidden`}>
                    {showChat ? (
                            ...
                            <div ref={scrollRef} className="flex-1 overflow-y-auto px-6 py-8 space-y-4 bg-[#FAFAFF]/40 min-h-0">
                                {messagesLoading && messages.length === 0 ? (
                                    ...
                                    messages.map((m, i) => {
                                        ...
                                        const senderLabelClass = m.senderRole === "rider"
                                        ...
                                        return (
                                            <MessageBubble
                                                ...
                                                senderLabelClass={senderLabelClass}
