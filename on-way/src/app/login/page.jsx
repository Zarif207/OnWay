      ...
      <div className="w-full max-w-5xl bg-white shadow-2xl rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row-reverse border border-white/20">
        ...
        <div className="md:w-[55%] p-8 lg:p-14 bg-white">
          <div className="flex justify-between items-center mb-10">
            ...
            <a
              href="/register"
              className="text-xs font-bold text-gray-400 hover:text-secondary transition-all flex items-center gap-1 group"
            >
              CREATE ACCOUNT{" "}
              <FaChevronRight
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div className="space-y-1">
              ...
              <div className="relative">
                <FaEnvelope
                  className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors ${errors.email ? "text-error" : "text-gray-300"}`}
                />
                <input
                  {...register("email", {
              ...
              {errors.email && (
                <span className="text-[10px] text-error font-bold ml-2">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <FaLock
                  className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors ${errors.password ? "text-error" : "text-gray-300"}`}
                />
                <input
                  {...register("password", {
          ...
          <div className="relative my-8 text-center">
            <span className="bg-white px-4 text-gray-400 text-xs font-bold relative z-10">
              OR CONTINUE WITH
            </span>
          ...
          <p className="mt-8 text-center text-[10px] text-gray-400 px-6 uppercase tracking-tight">
            ...
            <span className="text-neutral font-bold mx-1 cursor-pointer hover:underline">
              Privacy
            </span>
            .
          </p>
